                        ...
                        <div className="p-6 space-y-6 sm:p-8 relative">
                            ...
                            <form className="space-y-6" onSubmit={addPassword}>
                                ...
                                <div className="w-full text-center">
                                    {submitButton ? (
                                            <>
                                                <button type="submit" className="w-32 mx-3 text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center h-12">Adicionar</button>
                                                <button onClick={() => setAddItemFalse(false)} type="submit" className="w-32 mx-3 text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center h-12">Cancelar</button>
                                            </>    
                                        ):(
                                            <>
                                                <button type="submit" className="w-38 mx-3 text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center h-12" disabled>
