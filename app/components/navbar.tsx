            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:border-gray-700">
                        ...
                        <li>
                            <a href="./comingsoon" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Sobre</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="./comingsoon" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contatos</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <Menu as="div" className="relative ml-3 p-2 text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div>
                            <Menu.Button className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                <img className="h-8 w-8 rounded-full bg-white" src="/images/user-icon.png" alt=""/>
                            </Menu.Button>
                        </div>
                            ...
                            <>
                                ...
                                <Disclosure.Panel className="absolute left-0 mt-4 w-full rounded-md text-center bg-white text-gray-500">
                                    <ul>
                                        ...
                                        <li><Disclosure.Button className="w-full px-4 rounded-md py-4 text-sm hover:bg-gray-200 text-gray-700">Contatos</Disclosure.Button></li>
                                    </ul>
                                </Disclosure.Panel>
                            </>
                        )}
