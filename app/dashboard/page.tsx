            ...
            <div className="shadow-sm shadow-neutral-700">
              <div className="overflow-hidden rounded-md bg-white">
                ...
                <div className="px-3 pb-4 text-center">
                  <Link href="#" className="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 hover:bg-indigo-700 px-8 py-3 text-base font-medium text-white ">Acessar</Link>
                </div>
              </div>
            </div>
